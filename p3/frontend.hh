...
#line 251 "frontend.hh"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_arrayType = 55,                        // arrayType
        S_fnDecl = 56,                           // fnDecl
        S_formals = 57,                          // formals
        S_formalsList = 58,                      // formalsList
        S_formalDecl = 59,                       // formalDecl
        S_fnBody = 60,                           // fnBody
        S_stmtList = 61,                         // stmtList
        S_stmt = 62,                             // stmt
        S_blockStmt = 63,                        // blockStmt
        S_exp = 64,                              // exp
        S_assignExp = 65,                        // assignExp
